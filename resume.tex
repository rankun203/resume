...
\section{Experience}
\resumeHeadingListStart{}
  \resumeQuadHeading{Application Developer $\leftarrow$ Research Assistant}{Oct 2023 -- Present}
  {RMIT University, Deakin University}{Melbourne, Australia}
    \resumeItemListStart{}
      \resumeItem{Develop search engines, research platforms}
      \resumeItem{Research on IR, query variants, RAG systems, IR evaluation}
      \resumeItem{Participate in academic competitions}
